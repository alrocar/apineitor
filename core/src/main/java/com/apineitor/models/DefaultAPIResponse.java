...
public class DefaultAPIResponse<K, V> extends AbstractMap<K, V> implements
		Serializable, APIResponse {
	...
	public DefaultAPIResponse(Comparator<? super K> comparator) {
	...
	Node<K, V> findByEntry(Entry<?, ?> entry) {
		...
		boolean valuesEqual = mine != null
				&& equal(mine.value, entry.getValue());
