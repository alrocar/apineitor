...
import es.prodevelop.pui.http.client.APICallBack;
...
import es.prodevelop.pui.http.client.HttpContext;
...
import es.prodevelop.pui.http.client.request.PostParamHashMap;
import es.prodevelop.pui.http.client.request.QueryParamHashMap;
import es.prodevelop.pui.http.client.request.TemplateParamHashMap;
