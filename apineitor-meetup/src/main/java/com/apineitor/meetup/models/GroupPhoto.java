...
public class GroupPhoto implements APIResponse {
	 ...
	 * @param thumbLink
	 */
	public GroupPhoto(Long id, String highresLink, String photoLink,
			String thumbLink) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof GroupPhoto) == false) {
			return false;
		}
		GroupPhoto rhs = ((GroupPhoto) other);
